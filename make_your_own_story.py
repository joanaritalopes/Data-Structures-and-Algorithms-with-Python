...
story_root = TreeNode(
    ...
    A bear merges from the trees and roars!
    Do you:
    1) Roar back!
    2) Run to the left ...
    """
...
choice_b = TreeNode(
    """
    You come accross a clearing full of flowers.
...
choice_b_1 = TreeNode(
    """
    The bear is unamused. After smelling the flowers, it turns around and leaves you alone in the wilderness.
...
choice_b_2 = TreeNode(
    """
    The bear understands and apologizes for scaring you.
    Your new friend show you a path leading out of the forest.
